...
%         end
%     end
    rotateAngle = getHeadRotationAngle(sim.headOrientation, azRef);
    ...
    % Combine two blocks
    [post1, post2] = remove_front_back_confusion(post1, post2, rotateAngle);
    post2 = circshift(post2, rotateAngle/5);
    post = post1 + post2;
